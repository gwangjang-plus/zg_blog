"""
URL configuration for zgblog project.
...
# from apps.views import backend
# from apps.views.front_desk.article import article
# from apps.views.front_desk.history import history
from apps import views
# from apps.views.front_desk.moods import moods
# from apps.views.front_desk.news import news
# from apps.views.front_desk.oauth import oauth
# from apps.views.front_desk.search import search
# from apps.views.front_desk.sign import sign
# from apps.views.front_desk.sites import sites
# from apps.views.front_desk.about import about
# from apps.views.front_desk.project import project
# from apps.views.front_desk.login import login
# from apps.views.front_desk.logout import logout
# from apps.views.front_desk.get_random_code import get_random_code
