...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('nid', models.AutoField(primary_key=True, serialize=False)),
                ('url', models.FileField(upload_to='avatars/', verbose_name='头像地址')),
            ],
            options={
                'verbose_name': '头像',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nid', models.AutoField(primary_key=True, serialize=False)),
                ('nick', models.CharField(blank=True, max_length=16, null=True, verbose_name='昵称')),
                ('avatar_url', models.URLField(blank=True, null=True, verbose_name='用户头像')),
                ...
                ('token', models.CharField(blank=True, max_length=64, null=True, verbose_name='第三方登录ID')),
                ('ip', models.GenericIPAddressField(default='0.0.0.0', verbose_name='IP地址')),
                ('addr', models.TextField(blank=True, null=True, verbose_name='用户信息地址')),
                ('sign_status', models.IntegerField(choices=[(0, '用户名注册'), (1, 'QQ注册'), (2, 'gitee注册'), (3, '手机号注册'), (4, '邮箱注册')], default=0, verbose_name='注册来源')),
                ('account_status', models.IntegerField(choices=[(0, '正常'), (1, '异常'), (2, '注销/封禁')], default=0, verbose_name='账号状态')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='user_set', related_query_name='user', to='auth.permission', verbose_name='user permissions')),
                ('collects', models.ManyToManyField(blank=True, to='apps.articles', verbose_name='收藏的文章')),
                ('avatar', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='apps.avatars', verbose_name='用户头像')),
                ('navs', models.ManyToManyField(blank=True, to='apps.navs', verbose_name='收藏的网站')),
            ],
            options={
                'verbose_name': '用户',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='apps.articles', verbose_name='评论文章')),
                ('parent_comment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='apps.comment', verbose_name='是否是父评论')),
        ...
        migrations.AddField(
            model_name='articles',
            name='cover',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='apps.cover', verbose_name='文章封面'),
        ),
        migrations.CreateModel(
            name='Menu',
            fields=[
                ...
                ('menu_url', models.ManyToManyField(help_text='可以多选，多选就会轮播', to='apps.menuimg', verbose_name='菜单图片')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('digg_count', models.IntegerField(default=0, verbose_name='点赞数')),
                ('avatar', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='apps.avatars', verbose_name='心情的发布头像')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='apps.avatars', verbose_name='心情的发布头像')),
                ('mood', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='apps.moods', verbose_name='评论的心情')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='navs',
            name='tag',
            field=models.ManyToManyField(to='apps.navtags', verbose_name='网站标签'),
        ),
        migrations.CreateModel(
            name='Project',
            fields=[
                ('nid', models.AutoField(primary_key=True, serialize=False)),
                ('title', models.CharField(blank=True, max_length=32, null=True, verbose_name='标题')),
                ('article', models.ManyToManyField(to='apps.articles', verbose_name='文章')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='articles',
            name='tag',
            field=models.ManyToManyField(blank=True, to='apps.tags', verbose_name='文章标签'),
        ),
    ]
