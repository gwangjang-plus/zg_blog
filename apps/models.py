...
class UserInfo(AbstractUser):
    ...
    account_status:账号状态，
    avatar:头像表，
    collect_article:收藏的文章，
    nand_site:收藏的网站，
    }
    '''
    nid = models.AutoField(primary_key=True)
    nick = models.CharField(max_length=16, verbose_name='昵称',null=True,blank=True)
    ...
    token = models.CharField(max_length=64,verbose_name='第三方登录ID',null=True,blank=True)
    ip = models.GenericIPAddressField(verbose_name='IP地址',default='0.0.0.0')
    addr = models.TextField('用户信息地址',null=True,blank=True)
    sign_choise = (
        (0,'用户名注册'),
        (1,'QQ注册'),
        (2,'gitee注册'),
    ...
    sign_status = models.IntegerField(verbose_name='注册来源',default=0,choices=sign_choise)
    account_status_choise = (
        (0,'正常'),
        (1,'异常'),
        (2,'注销/封禁'),
    )
    account_status = models.IntegerField(verbose_name='账号状态',default=0,choices=account_status_choise)
...
class Avatars(models.Model):
    ...
    '''
    nid = models.AutoField(primary_key=True)
    url = models.FileField(verbose_name='头像地址',upload_to='avatars/')
    def __str__(self):
        return self.url
    class Meta:
        verbose_name = '头像'
